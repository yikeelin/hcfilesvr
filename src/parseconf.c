...
parseconf_uint_array[] = 
{
	...
	{ "portmodel_bind_port", &tunable_portmodel_bind_port },
...
parseconf_str_array[] = 
{
	...
	{ "username", &tunable_username },
	{ "password", &tunable_password },
	{ NULL, NULL }
};
...
void parseconf_load_setting(const char *setting)
{
	...
	if (strlen(value) == 0)
	{
		vdebugwrite(__FILE__, __LINE__, "misong value in config file for: %s", key);
		exit(EXIT_FAILURE);		
	}
